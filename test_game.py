...
def print_stats(results,NUM_GAMES):
    ...
    plt.legend()
    plt.show()
    plt.savefig('MCTS10'+str(NUM_GAMES))

    return player_1_countries_owned, player_2_countries_owned


def game_based_on_number_of_rounds(player1, player2, number_of_rounds, print_map, print_graph,NUM_GAMES,f):
    ...
    for i in range(number_of_rounds):
        ...
        f.write("Number of countries owned by player 1 in round: "+str(i) + str(player_1_countries_owned) + "\n")
        f.write("Number of countries owned by player 2 in round: "+str(i) + str(player_2_countries_owned) + "\n")
...
#     if print_graph:
#         print_stats(results,number_of_games)
...
#     NUM_GAMES = 10
#     specifications = "MCTS_Heuristic_rollout=10" #adjust this
...
#     #game_based_on_win_criteria('Heuristic', 'MCTS', True, False)
#     game_based_on_number_of_rounds('Heuristic', 'MCTS', 20, True, False)
#     return
...
def map_state_testing():
    number_of_games = 1
    experiment_type = "H_M_ORIGINAL_MAP"
    ...
    for i in range(number_of_games):
        f.write("Game: " + str(i) + "\n")
        f.write("Player 1: Heuristic, Player 2: MCTS" + "\n")
        results, test_game,f = game_based_on_number_of_rounds('Heuristic', 'MCTS', 25, True, True,number_of_games,f)
